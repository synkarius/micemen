...
public class WholeGameRecording {
	...
	public String toString() {
		...
		if (on)
			for (Turn t : turns) {
				readable.append(t.board).append('\n').append(t.activeTeam.toString()).append(" chooses ")
						.append("" + t.chosenShiftX).append('-').append(t.chosenShiftDir.toString()).append('\n')
						.append("results in").append('\n');
				t.moves.stream()
						.forEach(move -> readable.append(move.team.toString()).append(" : (").append("" + move.ox)
								.append(", ").append("" + move.oy).append(") -> (").append("" + move.dx).append(", ")
								.append("" + move.dy).append(")").append('\n'));
				readable.append('\n');
			}
